...
public partial class Page_P030101030302 : PageBase
{
    // JaJa暫時移除
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            /*rptResult = new ReportDocument();
                ...
                rptResult.DataDefinition.FormulaFields["Title1"].Text = "'維護員'";
                rptResult.DataDefinition.FormulaFields["Nam"].Text = "'" + strName + "'";
                rptResult.DataDefinition.FormulaFields["Title"].Text = "'新卡額度'";
