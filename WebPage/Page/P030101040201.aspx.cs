...
public partial class Page_P030101040201 : PageBase
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                //* 查詢
                if (BRReport.Report01010402_BySP(strRptBeforeDate, strRptEndDate, strRptSEQ, strMsgID, strName, blnOld, strAgentID, ref blnHadRecord, "P"))
                {
                    if (!blnHadRecord)
                    {
                        //* 沒有資料
                ...
                if (!BR_Excel_File.CreateExcelFile_Report01010402(strRptBeforeDate, strRptEndDate, strName, strAgentID, ref strServerPathFile, ref strMsgID))
                {
                ...
                string strFileName = "信用卡卡人資料查詢列印特殊額度自扣帳戶ID與卡人ID不同者" + strYYYYMMDD + ".xls";
        ...
        {
            Logging.Log(ex);
            MessageHelper.ShowMessage(this.Page, "03_01010000_000");
            return;
        }
    ...
    private void BindGridView()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                int totalCount = 0;
                DataTable dt = BR_Excel_File.getData_member1(strAgentID, ref totalCount, "01010402", this.gpList.CurrentPageIndex);
                if (dt.Rows.Count > 0)
                {
