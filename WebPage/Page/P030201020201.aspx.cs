...
public partial class Page_P030201020201 : PageBase
{
    /// <summary>
    /// Session變數集合
    /// </summary>
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //* 第一次進入頁面需要查詢
            if (BRReport.Report02010202_BySP(strRptID, strRptPeople, strRptBeforeDate, strRptEndDate, strRptSEQ, strMsgID, strName, blnOld, strAgentID, ref blnHadRecord, "P"))
            {
                if (!blnHadRecord)
                {
                    //* 沒有資料
            ...
            if (!BR_Excel_File.CreateExcelFile_Report02010202(strName, strRptPeople, strRptBeforeDate, strRptEndDate, strAgentID, ref strServerPathFile, ref strMsgID))
            {
            ...
            string strFileName = "信用卡卡片資料查詢列印統計表或關係表查詢卡片與維護員關係表" + strYYYYMMDD + ".xls";
    ...
    private void BindGridView()
    {
        ...
        try
        {
            ...
            int totalCount = 0;
            DataTable dt = BR_Excel_File.getData_Comm(strAgentID, string.Format(BR_Excel_File.sqlComm_01010202, UtilHelper.GetAppSettings("DB_CP_DBF")), ref totalCount, "02010202", this.gpList.CurrentPageIndex);
            if (dt.Rows.Count > 0)
            {
    ...
    {
        {
            ...
            this.grvUserView.Columns[2].HeaderText = BaseHelper.GetShowText("03_02010000_029");//維護員
