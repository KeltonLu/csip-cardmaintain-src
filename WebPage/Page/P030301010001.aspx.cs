...
public partial class Page_P030301010001 : PageBase
{
    /// <summary>
    /// Session變數集合
    /// </summary>
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                //* 查詢
                if (BRReport.Report03010100_BySP(strRptID, strRptPeople, strRptBeforeDate, strRptEndDate, strRptSEQ, strMsgID, strName, strAgentID, ref blnHadRecord, "P"))
                {
                    if (!blnHadRecord)
                    {
                        //* 沒有資料
                ...
                bool isCSV = false;
                if (!BR_Excel_File.CreateExcelFile_Report03010100(strRptID, strRptBeforeDate, strRptEndDate, strName, strAgentID, ref strServerPathFile, ref strMsgID, ref isCSV))
                {
                    //修改彈跳視窗與末端訊息一樣 by Ares Neal 2022/06/15
                ...
                if (!isCSV)
                {
                    strFileName = "VD卡人資料查詢列印維護記錄查詢" + strYYYYMMDD + ".xls";
                }
                else
                {
                    strFileName = "VD卡人資料查詢列印維護記錄查詢" + strYYYYMMDD + ".csv";
                }
        ...
        catch (Exception ex)
        {
            ...
            //修改彈跳視窗與末端訊息一樣 by Ares Neal 2022/06/15
            jsBuilder.RegScript(this.UpdatePanel1, BaseHelper.ClientMsgShow("03_03010000_000"));
            jsBuilder.RegScript(this.Page, string.Format("AlertConfirm({{title:'{0}'}});", MessageHelper.GetMessage("03_03010000_000")));
            return;
        }
    ...
    private void BindGridView()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                DataTable dt = BR_Excel_File.getData_member1(strAgentID, ref totalCount, "03010100", this.gpList.CurrentPageIndex, "S", isOrderBy);
    ...
    protected void ShowControlsText()
    {
        {
            //* 設置查詢結果GridView的列頭標題
            this.grvUserView.Columns[0].HeaderText = BaseHelper.GetShowText("03_03010000_021");
            this.grvUserView.Columns[1].HeaderText = BaseHelper.GetShowText("03_03010000_022");
            this.grvUserView.Columns[2].HeaderText = BaseHelper.GetShowText("03_03010000_023");
            this.grvUserView.Columns[3].HeaderText = BaseHelper.GetShowText("03_03010000_024");
            this.grvUserView.Columns[4].HeaderText = BaseHelper.GetShowText("03_03010000_025");
            this.grvUserView.Columns[5].HeaderText = BaseHelper.GetShowText("03_03010000_026");
            this.grvUserView.Columns[6].HeaderText = BaseHelper.GetShowText("03_03010000_027");
