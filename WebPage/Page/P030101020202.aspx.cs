...
public partial class Page_P030101020202 : PageBase
{
    // JaJa暫時移除
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            /*rptResult = new ReportDocument();
                ...
                rptResult.DataDefinition.FormulaFields["Con3"].Text = "'卡人ID'";
                rptResult.DataDefinition.FormulaFields["Con4"].Text = "'卡人與維護員關係表'";
