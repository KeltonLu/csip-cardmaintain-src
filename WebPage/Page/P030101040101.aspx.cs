...
public partial class Page_P030101040101 : PageBase
{   
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                //* 查詢
                if (BRReport.Report01010401_BySP(strRptBeforeDate, strRptEndDate, strRptSEQ, strMsgID, strName, blnOld, strAgentID, ref blnHadRecord, "P"))
                {
                    if (!blnHadRecord)
                    {
                        //* 沒有資料
                ...
                if (!BR_Excel_File.CreateExcelFile_Report01010401(strRptBeforeDate, strRptEndDate, strName, strAgentID, ref strServerPathFile, ref strMsgID))
                {
                ...
                string strFileName = "信用卡卡人資料查詢列印特殊額度員工調整紀錄" + strYYYYMMDD + ".xls";
    ...
    private void BindGridView()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                int totalCount = 0;
                DataTable dt = BR_Excel_File.getData_member(strAgentID, ref totalCount, "01010401", this.gpList.CurrentPageIndex);
                if (dt.Rows.Count > 0)
                {
