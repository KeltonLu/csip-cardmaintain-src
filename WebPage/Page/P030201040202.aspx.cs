...
public partial class Page_P030201040202 : PageBase
{
    // JaJa暫時移除
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strBeforeContent = RedirectHelper.GetDecryptString(this.Page, "BeforeContent");
            string strEndContent = RedirectHelper.GetDecryptString(this.Page, "EndContent");
            ...
            /*rptResult = new ReportDocument();
                ...
                rptResult.DataDefinition.FormulaFields["Title"].Text = "'年費無優惠調整爲優惠條件' ";
                rptResult.DataDefinition.FormulaFields["Con"].Text = "'調整前內容 : " + strBeforeContent + "'";
                rptResult.DataDefinition.FormulaFields["Con1"].Text = "'調整后內容 : " + strEndContent + "'";
