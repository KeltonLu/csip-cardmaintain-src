...
public partial class Page_P030201020402 : PageBase
{
    // JaJa暫時移除
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strRptFld = RedirectHelper.GetDecryptString(this.Page, "Fld");
            ...
            /*rptResult = new ReportDocument();
                string strRPTPathFile = AppDomain.CurrentDomain.BaseDirectory + ConfigurationManager.AppSettings["ReportTemplate"] + "card.rpt";
                rptResult.Load(@strRPTPathFile);

                rptResult.DataDefinition.FormulaFields["Nam"].Text = "'" + strName + "'";
                rptResult.DataDefinition.FormulaFields["Con"].Text = "'維護欄位:" + strRptFld.Trim() + "'";
                rptResult.DataDefinition.FormulaFields["Con1"].Text = "'維護日期 : " + strRptBeforeDate + " ~ " + strRptEndDate + "'";
                rptResult.DataDefinition.FormulaFields["Con2"].Text = "'卡人ID'";
                rptResult.DataDefinition.FormulaFields["Con3"].Text = "'卡片調整統計表'";
