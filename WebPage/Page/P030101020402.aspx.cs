...
public partial class Page_P030101020402 : PageBase
{
    // JaJa暫時移除
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            /*rptResult = new ReportDocument();
                ...
                rptResult.DataDefinition.FormulaFields["Con"].Text = "'維護欄位:" + strRptFld + "'";
                ...
                rptResult.DataDefinition.FormulaFields["Con3"].Text = "'卡人調整統計表'";
