...
public partial class Page_P030201030301 : PageBase
{
    //*排序欄位
    string strSEQ = "";
    //*查詢一年半以前資料
    ...
    {
        Page.Title = BaseHelper.GetShowText("03_02010000_016");
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtBeforeAmount.Text != "" || txtEndAmount.Text != "")
            {
                ...
                {
                    MessageHelper.ShowMessage(this.UpdatePanel1, "03_02010000_004");
                    return;
                }
            }
            ...
            try
            {
                ...
                //* 查詢
                if (BRReport.Report02010303_New(strRptPeople, strRptBeforeAmount, strRptEndAmount, strRptBeforeDate, strRptEndDate, strRptSEQ, strMsgID, strName, blnOld, strAgentID, ref blnHadRecord, "P"))
                {
                    if (!blnHadRecord)
                    {
                        //* 沒有資料
                ...
                if (!BR_Excel_File.CreateExcelFile_Report02010303(strRptPeople, strRptBeforeAmount, strRptEndAmount, strRptBeforeDate, strRptEndDate, strName, strAgentID, ref strServerPathFile, ref strMsgID))
                {
                ...
                string strFileName = "信用卡卡片資料查詢列印額度查詢新卡額度" + strYYYYMMDD + ".xls";
    ...
    private void BindGridView()
    {
        try
        {
            ...
            try
            {
                ...
                //* 查詢
                if (BRReport.Report02010303_New(strRptPeople, strRptBeforeAmount, strRptEndAmount, strRptBeforeDate, strRptEndDate, strRptSEQ, strMsgID, strName, blnOld, strAgentID, ref blnHadRecord))
                {
                    if (!blnHadRecord)
                    {
                        //* 沒有資料
                ...
                int totalCount = 0;
                DataTable dt = BR_Excel_File.getData_member1(strAgentID, ref totalCount, "02010303", this.gpList.CurrentPageIndex);
                if (dt.Rows.Count > 0)
                {
